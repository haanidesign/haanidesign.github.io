...
const TOOLS = [
  ...
  },
  {
    ...
    slug: "bongo",
    title: "ぼんご",
    desc: "打ったキーの横の位置に合わせて、左右の手が動くキャラクターの台。タブレットモードでは、ペンを持った手の絵がマウスについてきて、押すとタッチの絵にかわる。しばらく何もしないと待機の絵1枚にかわる。PSDを落とすとレイヤー名で振り分け、非表示の差分も名前が合えば使う。位置はステージの上で絵をつかんで合わせる。ひな形のPSDつき。",
