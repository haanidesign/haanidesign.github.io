...
const TOOLS = [
  ...
  },
  {
    ...
    slug: "bongo",
    title: "ぼんご",
    desc: "打ったキーの横の位置に合わせて、左手と右手が動くキャラクターの台。からだ・左手（上下）・右手（上下）・ペン・台の7パーツを自分の絵に差し替えられて、ファイル名で振り分かる。パーツごとに位置・大きさ・かたむきを合わせられる。打った時のはずみ、手のうごく幅も決められる。タブレットモードではペン先がマウスについてくる。背景を緑や青にして、配信の画面に重ねて使う。",
    tags: ["配信", "オーバーレイ", "キーボード", "差し替え", "透過PNG"],
    cat: "other",
