...
const TOOLS = [
  ...
  },
  {
    ...
    slug: "chara-kobo",
    title: "キャラクター工房",
    desc: "キャラの動きと表情を、その場で動かして確かめる台。3Dのモデルは外から読みこまず、骨組みも顔もこのページの中で組み立てている。待機・歩く・走るを切り替え、止めて1コマずつ送り、再生位置と速度を手で決められる。正面・左右の側面・後ろ・斜め・顔の拡大はボタン一発で、ドラッグとスクロールで好きな角度からも見られる。顔を左右に向けると髪と体が少し遅れてついてきて、その遅れは切って比べられる。表情はにっこり・目と口を閉じる、口の形は「あ」「い」「う・お」、自動の瞬きと会話の口の動きつき。左右の目と口はスライダーで手でも決められる。",
