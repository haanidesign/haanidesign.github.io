...
const TOOLS = [
  ...
  },
  {
    ...
    slug: "techo",
    title: "紙の手帳",
    desc: "1枚の紙に、文字も写真も手書きも重ねて残せる手帳。写真は貼り付け・ドラッグ・えらぶの3通りで入り、ペンは写真の上にも引ける。紙の右はしに見出しシールが並び、押すとその束へめくれる。1ページ＝1か月の予定表も同じ束に置けて、枡をさわればそのまま書ける。中の文字は束をまたいで探せて、新しい順・古い順・名前順に並べかえられる。書いたURLはそのまま押して飛べる。ゆびで紙を横にはらうとめくれ、はなした勢いで行き先が決まる。大きさは＋−でいつでも変えられ、どの画面でも同じ寸法で組まれる。読むだけの公開ページ（view.html）つき。",
