...
import { uid } from './engine/math.js?v=269';
...
export const WORK_KEYS = new Set([
  ...
  '_hmesh', '_hbase', '_bxy', '_huv',   // 手がき風の あみ
  '_pc', '_pkey',                       // おえかきの 紙
...
const paintKind = (l) => !!l && (l.kind === 'paint' || l.kind === 'solid' || l.kind === 'pano' || l.kind === 'room' || l.kind === 'talk' || l.kind === 'adjust');
