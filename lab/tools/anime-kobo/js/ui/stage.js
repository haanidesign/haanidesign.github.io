...
import { M, clamp } from '../engine/math.js?v=112';
import { cleanPath } from '../engine/path.js?v=112';
import { computeAll, pickLayer, hitsLayer, isFolder, membersOf,
         keepChildren, cornersOf } from '../engine/layer.js?v=112';
import { S, beginEdit, commitEdit, edit, onChange, selected, frameAsset, frameImage } from '../state.js?v=112';
import { hasPins, setPin, valuesAt, pinChX, pinChY, shiftTrack } from '../engine/anim.js?v=112';
import { buildMesh, buildMeshRect, meshSizeFor, newPin, precompute, needsPrecompute, deform, strokeMesh,
         bendChain } from '../engine/puppet.js?v=112';
import { createRenderer } from '../render/renderer.js?v=112';
import { attachInput } from './input.js?v=112';
import { newStroke, paintDirty } from '../engine/paint.js?v=112';
import { newCage, idxAt, restAt, movePoint, quadOf, setQuad,
         ...
         copyPts, setPts } from '../engine/warp.js?v=112';
