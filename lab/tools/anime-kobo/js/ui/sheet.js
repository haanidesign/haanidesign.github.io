...
import { S, onChange, beginEdit, commitEdit, edit, selected, addAsset } from '../state.js?v=211';
import { isDescendant, setParent, isFolder, membersOf, ungroup, mergeAsFrames,
         attachMany, copyLayers, pasteLayers, removeLayers,
         duplicateLayers, newPaintLayer, newSolidLayer,
         newFlip, isFlip, flipIndex, groupInto,
         splitFrames, newCamLayer, nearestFolder } from '../engine/layer.js?v=211';
import { hasPins, setPin, channelValue, valuesAt, spreadFrames,
         framePinTimes, removePin, pinChX, pinChY, EASES, EASE_LIST,
         curveAt, MY_EASE_MAX } from '../engine/anim.js?v=211';
import { swayKeys, swayPose, newSway, RIGID,
         afterKeys, afterAngle, afterLen, stopTimes } from '../engine/puppet.js?v=211';
import { pathKeys, pathLength, resample } from '../engine/path.js?v=211';
import { blinkKeys, talkKeys } from '../engine/anim.js?v=211';
import { PRESET_GROUPS, CATS } from '../engine/presets.js?v=211';
import { FONTS, renderTextLayer, shortName, newTextStyle, textToCanvas,
         addTextLayer } from '../io/text.js?v=211';
import { addBgLayer, paintBg, fitToCanvas, isBg,
         paintPattern, addPatternBg, DIR_PRESETS } from '../io/bg.js?v=211';
import { PATTERN_NAMES } from '../io/pattern.js?v=211';
import { isPano, addPanoLayer, spinKeys, sweepKeys, panoDefaults,
         PITCH_MAX } from '../engine/pano.js?v=211';
import { ballOn, ballDefaults, ballSpinKeys } from '../engine/ball.js?v=211';
import { isRoom, addRoomLayer, FACES as ROOM_FACES } from '../engine/room.js?v=211';
import { isTalk, addTalkLayer, talkDefaults, talkMouthKeys,
         talkEnd, talkStart } from '../engine/talk.js?v=211';
import { readAsDataURL, loadImage } from '../io/image.js?v=211';
import { isCam, camOf, resetCam, depthScale, is3D, ORBIT_MAX,
         DOLLY_MIN, DOLLY_MAX, depthOf, CAM_CHANNELS,
         DEPTH_MIN, DEPTH_MAX, DEPTH_PRESETS } from '../engine/camera.js?v=211';
import { bakeLayers, applyBake } from '../io/flatten.js?v=211';
import { newHand } from '../engine/hand.js?v=211';
import { newReveal, totalLen, paintDirty } from '../engine/paint.js?v=211';
import { createWheel, favs, addFav, delFav, hasFav, parseHex, hex as toHex }
  from './colorwheel.js?v=211';
import { A as AUD, hasAudio, clearAudio, voiceMouthKeys, speechSpans, levels,
         startRec, stopRec, cancelRec, isRecording, setPitch,
         guessBpm, firstOnset } from '../io/audio.js?v=211';
import { rhythmKeys, rhythmChannels, beatTimes, beatSec, markKeys,
         RHYTHM_KINDS, putHit } from '../engine/rhythm.js?v=211';
