...
import { S, addAsset } from '../state.js?v=176';
import { newLayer } from '../engine/layer.js?v=176';
import { loadImage } from './image.js?v=176';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=176';
