...
import { S, addAsset } from '../state.js?v=245';
import { newLayer } from '../engine/layer.js?v=245';
import { loadImage } from './image.js?v=245';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=245';
import { setPin } from '../engine/anim.js?v=245';
