...
import { S, addAsset } from '../state.js?v=244';
import { newLayer } from '../engine/layer.js?v=244';
import { loadImage } from './image.js?v=244';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=244';
import { setPin } from '../engine/anim.js?v=244';
