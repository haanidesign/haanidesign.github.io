...
import { S, addAsset } from '../state.js?v=256';
import { newLayer } from '../engine/layer.js?v=256';
import { loadImage } from './image.js?v=256';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=256';
import { setPin } from '../engine/anim.js?v=256';
