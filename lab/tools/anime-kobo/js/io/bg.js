...
import { S, addAsset } from '../state.js?v=225';
import { newLayer } from '../engine/layer.js?v=225';
import { loadImage } from './image.js?v=225';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=225';
import { setPin } from '../engine/anim.js?v=225';
