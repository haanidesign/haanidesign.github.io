...
import { S, addAsset } from '../state.js?v=172';
import { newLayer } from '../engine/layer.js?v=172';
import { loadImage } from './image.js?v=172';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=172';
import { setPin } from '../engine/anim.js?v=172';
