...
import { S, addAsset } from '../state.js?v=130';
import { newLayer } from '../engine/layer.js?v=130';
import { loadImage } from './image.js?v=130';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=130';
import { setPin } from '../engine/anim.js?v=130';
