...
import { S, addAsset } from '../state.js?v=259';
import { newLayer } from '../engine/layer.js?v=259';
import { loadImage } from './image.js?v=259';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=259';
import { setPin } from '../engine/anim.js?v=259';
