...
import { newLayer } from '../engine/layer.js?v=240';
import { loadImage } from './image.js?v=240';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=240';
import { setPin } from '../engine/anim.js?v=240';
