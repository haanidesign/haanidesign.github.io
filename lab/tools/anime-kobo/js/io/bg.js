...
import { S, addAsset } from '../state.js?v=158';
import { newLayer } from '../engine/layer.js?v=158';
import { loadImage } from './image.js?v=158';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=158';
import { setPin } from '../engine/anim.js?v=158';
