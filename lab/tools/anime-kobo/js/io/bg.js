...
import { S, addAsset } from '../state.js?v=75';
import { newLayer } from '../engine/layer.js?v=75';
import { loadImage } from './image.js?v=75';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=75';
import { setPin } from '../engine/anim.js?v=75';
