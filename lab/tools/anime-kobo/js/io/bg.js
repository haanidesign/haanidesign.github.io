...
import { S, addAsset } from '../state.js?v=236';
import { newLayer } from '../engine/layer.js?v=236';
import { loadImage } from './image.js?v=236';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=236';
import { setPin } from '../engine/anim.js?v=236';
