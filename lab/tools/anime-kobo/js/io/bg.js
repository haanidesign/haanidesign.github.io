...
import { S, addAsset } from '../state.js?v=284';
import { newLayer } from '../engine/layer.js?v=284';
import { loadImage } from './image.js?v=284';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=284';
import { setPin } from '../engine/anim.js?v=284';
