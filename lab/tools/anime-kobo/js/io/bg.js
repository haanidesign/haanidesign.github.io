...
import { S, addAsset } from '../state.js?v=264';
import { newLayer } from '../engine/layer.js?v=264';
import { loadImage } from './image.js?v=264';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=264';
import { setPin } from '../engine/anim.js?v=264';
