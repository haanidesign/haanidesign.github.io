...
import { S, addAsset } from '../state.js?v=262';
import { newLayer } from '../engine/layer.js?v=262';
import { loadImage } from './image.js?v=262';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=262';
import { setPin } from '../engine/anim.js?v=262';
