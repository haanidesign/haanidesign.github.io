...
import { newLayer } from '../engine/layer.js?v=59';
import { loadImage } from './image.js?v=59';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=59';
import { setPin } from '../engine/anim.js?v=59';
