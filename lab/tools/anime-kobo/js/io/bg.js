...
import { S, addAsset } from '../state.js?v=51';
import { newLayer } from '../engine/layer.js?v=51';
import { loadImage } from './image.js?v=51';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=51';
import { setPin } from '../engine/anim.js?v=51';
