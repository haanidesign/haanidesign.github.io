...
import { S, addAsset } from '../state.js?v=71';
import { newLayer } from '../engine/layer.js?v=71';
import { loadImage } from './image.js?v=71';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=71';
import { setPin } from '../engine/anim.js?v=71';
