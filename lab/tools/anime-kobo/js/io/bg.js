...
import { S, addAsset } from '../state.js?v=263';
import { newLayer } from '../engine/layer.js?v=263';
import { loadImage } from './image.js?v=263';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=263';
import { setPin } from '../engine/anim.js?v=263';
