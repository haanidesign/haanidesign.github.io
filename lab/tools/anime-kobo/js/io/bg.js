...
import { S, addAsset } from '../state.js?v=167';
import { newLayer } from '../engine/layer.js?v=167';
import { loadImage } from './image.js?v=167';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=167';
import { setPin } from '../engine/anim.js?v=167';
