...
import { S, addAsset } from '../state.js?v=68';
import { newLayer } from '../engine/layer.js?v=68';
import { loadImage } from './image.js?v=68';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=68';
import { setPin } from '../engine/anim.js?v=68';
