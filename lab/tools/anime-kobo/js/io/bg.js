...
import { S, addAsset } from '../state.js?v=201';
import { newLayer } from '../engine/layer.js?v=201';
import { loadImage } from './image.js?v=201';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=201';
