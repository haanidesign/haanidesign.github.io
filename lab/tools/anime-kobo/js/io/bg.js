...
import { S, addAsset } from '../state.js?v=189';
import { newLayer } from '../engine/layer.js?v=189';
import { loadImage } from './image.js?v=189';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=189';
