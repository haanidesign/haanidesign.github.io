...
import { newLayer } from '../engine/layer.js?v=179';
import { loadImage } from './image.js?v=179';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=179';
import { setPin } from '../engine/anim.js?v=179';
