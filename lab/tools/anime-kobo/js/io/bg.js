...
import { S, addAsset } from '../state.js?v=164';
import { newLayer } from '../engine/layer.js?v=164';
import { loadImage } from './image.js?v=164';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=164';
import { setPin } from '../engine/anim.js?v=164';
