...
import { S, addAsset } from '../state.js?v=65';
import { newLayer } from '../engine/layer.js?v=65';
import { loadImage } from './image.js?v=65';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=65';
import { setPin } from '../engine/anim.js?v=65';
