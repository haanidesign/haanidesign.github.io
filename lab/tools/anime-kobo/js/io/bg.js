...
import { S, addAsset } from '../state.js?v=78';
import { newLayer } from '../engine/layer.js?v=78';
import { loadImage } from './image.js?v=78';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=78';
import { setPin } from '../engine/anim.js?v=78';
