...
import { S, addAsset } from '../state.js?v=205';
import { newLayer } from '../engine/layer.js?v=205';
import { loadImage } from './image.js?v=205';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=205';
import { setPin } from '../engine/anim.js?v=205';
