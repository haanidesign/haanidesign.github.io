...
import { S, addAsset } from '../state.js?v=285';
import { newLayer } from '../engine/layer.js?v=285';
import { loadImage } from './image.js?v=285';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=285';
import { setPin } from '../engine/anim.js?v=285';
