...
import { S, addAsset } from '../state.js?v=69';
import { newLayer } from '../engine/layer.js?v=69';
import { loadImage } from './image.js?v=69';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=69';
import { setPin } from '../engine/anim.js?v=69';
