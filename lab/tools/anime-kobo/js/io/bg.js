...
import { newLayer } from '../engine/layer.js?v=61';
import { loadImage } from './image.js?v=61';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=61';
import { setPin } from '../engine/anim.js?v=61';
