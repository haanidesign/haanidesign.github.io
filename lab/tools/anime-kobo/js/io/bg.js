...
import { S, addAsset } from '../state.js?v=247';
import { newLayer } from '../engine/layer.js?v=247';
import { loadImage } from './image.js?v=247';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=247';
import { setPin } from '../engine/anim.js?v=247';
