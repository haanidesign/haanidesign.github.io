...
import { newLayer } from '../engine/layer.js?v=153';
import { loadImage } from './image.js?v=153';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=153';
import { setPin } from '../engine/anim.js?v=153';
