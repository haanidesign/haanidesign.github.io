...
import { S, addAsset } from '../state.js?v=93';
import { newLayer } from '../engine/layer.js?v=93';
import { loadImage } from './image.js?v=93';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=93';
import { setPin } from '../engine/anim.js?v=93';
