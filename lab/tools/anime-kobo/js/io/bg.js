...
import { S, addAsset } from '../state.js?v=243';
import { newLayer } from '../engine/layer.js?v=243';
import { loadImage } from './image.js?v=243';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=243';
import { setPin } from '../engine/anim.js?v=243';
