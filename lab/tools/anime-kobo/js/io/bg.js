...
import { newLayer } from '../engine/layer.js?v=242';
import { loadImage } from './image.js?v=242';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=242';
import { setPin } from '../engine/anim.js?v=242';
