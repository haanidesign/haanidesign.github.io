...
import { S, addAsset } from '../state.js?v=229';
import { newLayer } from '../engine/layer.js?v=229';
import { loadImage } from './image.js?v=229';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=229';
import { setPin } from '../engine/anim.js?v=229';
