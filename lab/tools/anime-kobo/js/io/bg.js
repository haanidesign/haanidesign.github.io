...
import { S, addAsset } from '../state.js?v=188';
import { newLayer } from '../engine/layer.js?v=188';
import { loadImage } from './image.js?v=188';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=188';
import { setPin } from '../engine/anim.js?v=188';
