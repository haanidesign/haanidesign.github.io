...
import { newLayer } from '../engine/layer.js?v=82';
import { loadImage } from './image.js?v=82';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=82';
import { setPin } from '../engine/anim.js?v=82';
