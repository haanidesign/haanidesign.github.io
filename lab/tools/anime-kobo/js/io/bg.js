...
import { S, addAsset } from '../state.js?v=257';
import { newLayer } from '../engine/layer.js?v=257';
import { loadImage } from './image.js?v=257';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=257';
import { setPin } from '../engine/anim.js?v=257';
