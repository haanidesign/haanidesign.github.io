...
import { newLayer } from '../engine/layer.js?v=60';
import { loadImage } from './image.js?v=60';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=60';
import { setPin } from '../engine/anim.js?v=60';
