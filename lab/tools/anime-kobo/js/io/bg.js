...
import { S, addAsset } from '../state.js?v=163';
import { newLayer } from '../engine/layer.js?v=163';
import { loadImage } from './image.js?v=163';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=163';
import { setPin } from '../engine/anim.js?v=163';
