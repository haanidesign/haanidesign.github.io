...
import { S, addAsset } from '../state.js?v=160';
import { newLayer } from '../engine/layer.js?v=160';
import { loadImage } from './image.js?v=160';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=160';
import { setPin } from '../engine/anim.js?v=160';
