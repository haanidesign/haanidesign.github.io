...
import { S, addAsset } from '../state.js?v=159';
import { newLayer } from '../engine/layer.js?v=159';
import { loadImage } from './image.js?v=159';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=159';
import { setPin } from '../engine/anim.js?v=159';
