...
import { S, addAsset } from '../state.js?v=191';
import { newLayer } from '../engine/layer.js?v=191';
import { loadImage } from './image.js?v=191';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=191';
import { setPin } from '../engine/anim.js?v=191';
