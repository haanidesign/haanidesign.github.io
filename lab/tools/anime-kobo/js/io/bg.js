...
import { S, addAsset } from '../state.js?v=216';
import { newLayer } from '../engine/layer.js?v=216';
import { loadImage } from './image.js?v=216';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=216';
import { setPin } from '../engine/anim.js?v=216';
