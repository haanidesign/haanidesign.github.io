...
import { S, addAsset } from '../state.js?v=254';
import { newLayer } from '../engine/layer.js?v=254';
import { loadImage } from './image.js?v=254';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=254';
import { setPin } from '../engine/anim.js?v=254';
