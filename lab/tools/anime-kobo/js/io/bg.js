...
import { S, addAsset } from '../state.js?v=92';
import { newLayer } from '../engine/layer.js?v=92';
import { loadImage } from './image.js?v=92';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=92';
import { setPin } from '../engine/anim.js?v=92';
