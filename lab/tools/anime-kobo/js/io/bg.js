...
import { S, addAsset } from '../state.js?v=267';
import { newLayer } from '../engine/layer.js?v=267';
import { loadImage } from './image.js?v=267';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=267';
import { setPin } from '../engine/anim.js?v=267';
