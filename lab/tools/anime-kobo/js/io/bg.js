...
import { S, addAsset } from '../state.js?v=79';
import { newLayer } from '../engine/layer.js?v=79';
import { loadImage } from './image.js?v=79';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=79';
import { setPin } from '../engine/anim.js?v=79';
