...
import { S, addAsset } from '../state.js?v=96';
import { newLayer } from '../engine/layer.js?v=96';
import { loadImage } from './image.js?v=96';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=96';
import { setPin } from '../engine/anim.js?v=96';
