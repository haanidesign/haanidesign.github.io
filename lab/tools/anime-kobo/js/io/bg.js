...
import { S, addAsset } from '../state.js?v=127';
import { newLayer } from '../engine/layer.js?v=127';
import { loadImage } from './image.js?v=127';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=127';
import { setPin } from '../engine/anim.js?v=127';
