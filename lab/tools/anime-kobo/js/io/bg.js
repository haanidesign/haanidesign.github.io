...
import { S, addAsset } from '../state.js?v=258';
import { newLayer } from '../engine/layer.js?v=258';
import { loadImage } from './image.js?v=258';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=258';
import { setPin } from '../engine/anim.js?v=258';
