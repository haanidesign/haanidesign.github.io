...
import { S, addAsset } from '../state.js?v=204';
import { newLayer } from '../engine/layer.js?v=204';
import { loadImage } from './image.js?v=204';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=204';
