...
import { S, addAsset } from '../state.js?v=174';
import { newLayer } from '../engine/layer.js?v=174';
import { loadImage } from './image.js?v=174';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=174';
import { setPin } from '../engine/anim.js?v=174';
