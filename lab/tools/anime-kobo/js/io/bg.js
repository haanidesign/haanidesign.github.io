...
import { S, addAsset } from '../state.js?v=253';
import { newLayer } from '../engine/layer.js?v=253';
import { loadImage } from './image.js?v=253';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=253';
import { setPin } from '../engine/anim.js?v=253';
