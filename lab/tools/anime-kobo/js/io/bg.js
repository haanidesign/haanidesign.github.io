...
import { S, addAsset } from '../state.js?v=56';
import { newLayer } from '../engine/layer.js?v=56';
import { loadImage } from './image.js?v=56';
import { makePattern, fitShift, PATTERNS } from './pattern.js?v=56';
import { setPin } from '../engine/anim.js?v=56';
