...
import { S, addAsset, edit } from '../state.js?v=242';
import { newLayer, newFolder, setParent } from '../engine/layer.js?v=242';
import { contentBox, loadImage } from './image.js?v=242';
