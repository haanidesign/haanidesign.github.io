...
import { S, addAsset, edit } from '../state.js?v=287';
import { newLayer, newFolder, setParent } from '../engine/layer.js?v=287';
import { contentBox, loadImage } from './image.js?v=287';
