...
import { S, isDraft } from '../state.js?v=296';
import { drawDeformed } from './puppet.js?v=296';
import { newLayer, valuesAt } from './layer.js?v=296';
import { camOf, camDolly } from './camera.js?v=296';
