...
import { S, isDraft } from '../state.js?v=287';
import { drawDeformed } from './puppet.js?v=287';
import { newLayer, valuesAt } from './layer.js?v=287';
import { camOf, camDolly } from './camera.js?v=287';
