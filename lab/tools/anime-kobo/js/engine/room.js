...
import { S, isDraft } from '../state.js?v=247';
import { drawDeformed } from './puppet.js?v=247';
import { newLayer, valuesAt } from './layer.js?v=247';
import { camOf, camDolly } from './camera.js?v=247';
