...
import { S, isDraft } from '../state.js?v=267';
import { drawDeformed } from './puppet.js?v=267';
import { newLayer, valuesAt } from './layer.js?v=267';
import { camOf, camDolly } from './camera.js?v=267';
