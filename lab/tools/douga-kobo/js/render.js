/* ステージ（プレビュー）に えがく。 */
import { S, clamp, findClip } from './state.js?v=18';
import { MEDIA, animFrame } from './media.js?v=18';
import { drawText as paintText, textBox, glyphSpots } from './text.js?v=18';
import { beatOn, beatAt } from './beat.js?v=18';
