/* ステージ（プレビュー）に えがく。 */
import { S, clamp, findClip } from './state.js?v=20';
import { MEDIA, animFrame } from './media.js?v=20';
import { drawText as paintText, textBox, glyphSpots } from './text.js?v=20';
import { beatOn, beatAt } from './beat.js?v=20';
