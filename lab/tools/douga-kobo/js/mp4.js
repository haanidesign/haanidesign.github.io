...
import { S, clamp, duration, allClips, r2 } from './state.js?v=12';
import { MEDIA, animFrameAt } from './media.js?v=12';
import { renderOut, outCanvas, activeClips } from './render.js?v=12';
import { fadeAlpha } from './render.js?v=12';
