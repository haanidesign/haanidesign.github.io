...
import { MEDIA, paintPoster, paintPeaks } from '../media.js?v=65';
import { bus } from '../bus.js?v=65';
import { beatOn, stepSec, beatSec, nearestStep, beatAt } from '../beat.js?v=65';
import { durOf as jzDur } from '../jz.js?v=65';
