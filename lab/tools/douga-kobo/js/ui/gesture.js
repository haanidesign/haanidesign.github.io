...
import { S, clamp, findClip, selected, snap as pushUndo, buzz } from '../state.js?v=18';
import { clipBox, handlePoints, toProject, panView, zoomAt, charSpots } from '../render.js?v=18';
import { setOff, offOf } from '../text.js?v=18';
